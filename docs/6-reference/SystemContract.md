...
| :----: | :------ | :------ |
| Vote creator account name | string | Create a vote that requires pledge 1000 AIOU, which will be deducted from the creator account, and the creator account has the admin privilege to vote |
